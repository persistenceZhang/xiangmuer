...
<iframe src="ysxx2.php" id="iframe4" scrolling="no" WIDTH="1080PX"HEIGHT="700PX" ></iframe>
</div>
<script>
	...
	function transTo(n){
		if(n==1){$("iframe4").src="ysxx2.php";}//已收信息
		else if(n==2){$("iframe4").src="yfxx2.php";}//已发信息
		else if(n==3){$("iframe4").src="bxxx2.php";}//编写信息
		else{window.location.href='information2.php';}
    }
</script>
